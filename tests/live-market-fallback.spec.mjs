...
const set = artifactKlineSet({ h1: candles1h, h4: candles4h, d1: candles1d });
...
// can decide whether to tag the artifact STALE rather than green.
// ─────────────────────────────────────────────────────────────────────
...
for (const key of ['candles_1h', 'candles_4h', 'candles_1d', 'derivatives']) {
